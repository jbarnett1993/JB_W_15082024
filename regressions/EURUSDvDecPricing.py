...
dependent_variable = ["EURUSD Curncy"]
independent_variables = [".EUUSDEC Index"]
...
# second_most_recent_x = X[independent_variables].iloc[-85:-40]
# second_most_recent_y = y.iloc[-85:-40]

most_recent_x = X[independent_variables].iloc[-1]
most_recent_y = y.iloc[-1]

# plt.scatter(second_most_recent_x, second_most_recent_y, color='green')
...
plt.title('EURUSD v EUvUS Dec Rate Pricing')
plt.xlabel('EUvUS Dec Pricing Spread')
